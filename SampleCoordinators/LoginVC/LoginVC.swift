...
final class LoginVC : UIViewController {
    ...
    func setupViews() {
        ...
        subViews.anchor(top: nil, leading: view.leadingAnchor, bottom: nil, trailing: view.trailingAnchor, padding: UIEdgeInsets(top: 0, left: 10, bottom: 0, right: 10), size: CGSize(width: 0, height: view.frame.height / 3))
